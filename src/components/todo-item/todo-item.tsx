...
export const useDeleteTodo = globalAction$(
  async (todo: Partial<Todo>) => todoService.deleteTodo(todo.id!),
  zod$({ id: z.string().uuid() })
);

export const useEditTodo = globalAction$(
  async (todo: Todo) => todoService.updateTodo(todo),
  zod$({
    id: z.string().uuid(),
...
export const useToggleTodo = globalAction$(
  async (todo: Partial<Todo>) => todoService.toggleTodo(todo as Todo),
  zod$({ id: z.string().uuid() })
);
